...
#
# Generated by export_simulation on Tue May 13 10:29:01 +0330 2025
#
################################################################################
...
'-reset_run' switch to the './iF_ARM.sh' script.
...
./iF_ARM.sh -noclean_files

For more information on the script, please type './iF_ARM.sh -help'.
